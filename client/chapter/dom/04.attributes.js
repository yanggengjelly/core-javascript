...
first.setAttribute('data-index', '2');

first.dataset.name = 'tiger';

// - elementNode.removeAttribute(name) – 속성값을 지움

// first.removeAttiribute('class');
...
function attr(node, prop, value) {
  ...
  //삼항식 return !value ? getAttr(node,prop) : setAttr(node,prop,value)
  // 화살표 함수 const attr = (node,prop,value) => !value ? getAttr(node,prop) : setAttr(node,prop,value)
}
